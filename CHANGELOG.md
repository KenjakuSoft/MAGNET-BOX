...
- **Download health** — each torrent now shows its **live peer count** next to speed and ETA, so you can tell at a glance whether it's healthy or stuck (e.g. `45% · 8 peers · 12m left`).
